...
class MasterCtrl extends CI_Controller {
    ...
    // for ($i = 0; $i < count($q_question); $i++) {
    //     $form_data_question = array(
    //         'fk_quiz_id' => $insert_id,   
    //         'q_question' => $q_question[$i],   
    //         'q_op1' => $q_op1[$i],   
    //         'q_op2' => $q_op2[$i],   
    //         'q_op3' => $q_op3[$i],   
    //         'q_op4' => $q_op4[$i],        
    //         'q_answer' => $q_answer[$i],              
    //          );
    //      $this->MasterMdl->add_quiz_question($form_data_question);  
    ...
    //             'q_answer' => $this->input->post('q_answer'),                
    //              );
    //                 if ($this->MasterMdl->edit_quiz_question($id,$form_data)) {
    //                     $_SESSION['responsemsg'] = "Edited Successfully";
    //                     redirect('view_quiz');
    //                 } else {
    //                     $_SESSION['responsemsg'] = "Error!";
    ...
    //                 }
    //             }
    //             $where = array('qq.qq_id' => $id);
    //             $data['row'] = $this->MasterMdl->get_quiz_question($where);
    ...
    public function add_order() {
        ...
        if (isset($_POST['update'])) {         
            ...
            if($isInventoryAvailable) {
                ...
                $order_number = "PO".$unque_order_id;
                $order_data = array(
                    'order_number' => $order_number,
