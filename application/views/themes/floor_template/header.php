<?php if(!isset($_SESSION['all'])){redirect('login');}?>
<!doctype html>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="<?php echo site_url(); ?>/admin_dashboard"><img class="main-logo4" src="<?php echo base_url(); ?>assets/img/logo/yourlogo.png" alt="" style="height:100px;" /></a>
                <strong><a href="<?php echo site_url(); ?>/admin_dashboard"><img src="<?php echo base_url(); ?>assets/img/logo/logosn.png" alt="" /></a></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <!-- <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                ...
                                <li><a title="Dashboard v.2" href="<?php echo site_url(); ?>/view_user"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                        ...
                        <li>
                            <a title="Landing Page" href="<?= site_url();?>/admin_dashboard" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">DashBoard</span></a>
                        </li>
                        <?php } ?>
                        <li class="active">
                            <a class="has-arrow" href="index.html">
                            ...
                            <?php if($_SESSION['all']['l_role'] == 'superadmin'){?>
                                <li><a title="Dashboard v.3" href="<?php echo site_url(); ?>/view_zone"><span class="mini-sub-pro">View Zone</span></a></li>
                                <!-- <li><a title="Dashboard v.3" href="<?php echo site_url(); ?>/view_brand"><span class="mini-sub-pro">View Brand</span></a></li> -->
                                <li><a title="Analytics" href="<?php echo site_url(); ?>/view_category"><span class="mini-sub-pro">View Category</span></a></li>
                                <li><a title="Dashboard v.1" href="<?php echo site_url(); ?>/view_user"><span class="mini-sub-pro">View Users</span></a></li>
                                <?php } ?>
                            <?php if($_SESSION['all']['l_role'] == 'superadmin' || $_SESSION['all']['l_role'] == 'admin' ){?>
                         
                                <li><a title="Dashboard v.1" href="<?php echo site_url(); ?>/view_shop"><span class="mini-sub-pro">View Sub-Category</span></a></li>
                                <li><a title="Dashboard v.2" href="<?php echo site_url(); ?>/view_orders"><span class="mini-sub-pro">View Orders</span></a></li>                                
                                <li><a title="Widgets" href="<?php echo site_url(); ?>/view_advertisment"><span class="mini-sub-pro">View Advertisment</span></a></li>
                                <!-- <li><a title="Dashboard v.2" href="<?php echo site_url(); ?>/view_news"><span class="mini-sub-pro">View News</span></a></li>    -->
                                <!-- <li><a title="Dashboard v.2" href="<?php echo site_url(); ?>/view_quiz"><span class="mini-sub-pro">View Quiz</span></a></li>    -->
                        ...
                        <!-- <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Professor" href="add-professor.html"><span class="mini-sub-pro">View Professor</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Students" href="add-student.html"><span class="mini-sub-pro">View Student</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Courses" href="add-course.html"><span class="mini-sub-pro">View Course</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Library" href="add-library-assets.html"><span class="mini-sub-pro">View Library Asset</span></a></li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Departments" href="add-department.html"><span class="mini-sub-pro">View Departments</span></a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo5" src="<?php echo base_url(); ?>assets/img/logo/logo.png"  style="visibility:hidden;"  alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item dropdown">
                                                    <select id="home_type" name="home_type" class="form-control" onchange="set_home_type(this.value);" style="width:100px;height:33px;"  >
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle" onclick="get_notification_list();">  
                                                        <button type="button" class="btn btn-success">New Orders <span class="badge show_count"></span></button></i>
                                                    </a>
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        <div class="message-single-top">
                                                            <h1>View All Orders</h1>
                                                        </div>
                                                        <ul class="message-menu get_notification_list">                                                            
                                                            
                                                        </ul>
                                                        <div class="message-view">
                                                            <a  href="<?= site_url();?>/view_orders" style="color:blue;">View All Orders</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="<?php echo base_url(); ?>assets/img/product/userimage.png" alt="" />
															<span class="admin-name"><?php if (isset($_SESSION['all']['l_name'])) echo $_SESSION['all']['l_name'];?></span>
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="<?= site_url();?>/logout"><span class="edu-icon edu-locked author-log-ic"></span>Log Out</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="<?php echo site_url(); ?>/view_user">Dashboard v.2</a></li>
