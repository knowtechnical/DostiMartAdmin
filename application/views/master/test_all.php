                                                ...
                                                <div class="chat-discussion" style="height: auto">
                                                    <div class="chat-message">
														<div class="profile-hdtc">
															  <img class="message-avatar" src="<?php echo base_url(); ?>assets/img/contact/1.jpg" alt="">
														</div>
                                                        <div class="message">
                                                    ...
                                                    <div class="chat-message">
														<div class="profile-hdtc">
															  <img class="message-avatar" src="<?php echo base_url(); ?>assets/img/contact/2.jpg" alt="">
														</div>
                                                        <div class="message">
                                                    ...
                                                    <div class="chat-message">
														<div class="profile-hdtc">
															  <img class="message-avatar" src="<?php echo base_url(); ?>assets/img/contact/3.jpg" alt="">
														</div>
                                                        <div class="message">
                                                            <a class="message-author" href="#"> Michael Smith </a>
                                                            <span class="message-date">  Fri Jan 25 2015 - 11:12:36 </span>
                                                    ...
                                                    <div class="chat-message">
														<div class="profile-hdtc">
															  <img class="message-avatar" src="<?php echo base_url(); ?>assets/img/contact/4.jpg" alt="">
														</div>
                                                        <div class="message">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img alt="logo" class="img-circle m-b" src="<?php echo base_url(); ?>assets/img/contact/1.jpg">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img alt="logo" class="img-circle m-b" src="<?php echo base_url(); ?>assets/img/contact/2.jpg">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs responsive-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img alt="logo" class="img-circle m-b" src="<?php echo base_url(); ?>assets/img/contact/3.jpg">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="hpanel hblue contact-panel contact-panel-cs res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="panel-body custom-panel-jw">
                                ...
                                <img alt="logo" class="img-circle m-b" src="<?php echo base_url(); ?>assets/img/contact/4.jpg">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="<?php echo base_url(); ?>assets/img/student/1.jpg" alt="" />
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30">
                            <div class="student-img">
                                <img src="<?php echo base_url(); ?>assets/img/student/2.jpg" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>Alexam Angles</h2>
                                <p class="dp">Computer Science</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-mg-b-30 res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="student-img">
                                <img src="<?php echo base_url(); ?>assets/img/student/3.jpg" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>Alexam Angles</h2>
                                <p class="dp">Computer Science</p>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="student-inner-std res-tablet-mg-t-30 dk-res-t-pro-30">
                            <div class="student-img">
                                <img src="<?php echo base_url(); ?>assets/img/student/4.jpg" alt="" />
                            </div>
                            <div class="student-dtl">
                                <h2>Alexam Angles</h2>
                                <p class="dp">Computer Science</p>
